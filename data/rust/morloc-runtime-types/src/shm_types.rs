...
/// for filling `slot_count` / `gen_salt` and finally storing
/// `STREAM_REGISTRY_MAGIC` with Release ordering. Concurrent attaching
/// processes observe this sentinel and continue spin-waiting.
pub const STREAM_REGISTRY_MAGIC_INIT: u64 = 0x4D4C_5354_5245_4749; // "MLSTREGI"
