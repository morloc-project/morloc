...
//! constraint by INTERSECTING the three sources -- program EnvSpec ∩ user pin ∩
...
fn bad(msg: String) -> ManagerError {
    ManagerError::EnvError(msg)
}
...
mod tests {
    ...
    fn intersection_clamps() {
        // author >=3.11 ∩ supported >=3.10,<3.14 -> >=3.11,<3.14
