...
renderConcreteForm (VariantF (FV _ cv) _) = unCVar cv
...
-- Which form a constructor takes is a property of its TYPE, not of the
-- constructor: an argument-free arm of a payload-bearing `data` is still a
