...
toE (AnnoS g _ (EnumS _ n _)) = LitP g (MStr n)
...
toE (AnnoS g _ (ExeS (PatCall PatternBracketIndex))) = BracketIndexP g
toE (AnnoS g _ (ExeS (PatCall PatternBracketSlice))) = BracketSliceP g
...
indexOfE (BracketIndexP (Idx i _)) = i
indexOfE (BracketSliceP (Idx i _)) = i
...
typeOfE (BracketIndexP (Idx _ t)) = t
typeOfE (BracketSliceP (Idx _ t)) = t
...
checkPair i e1 e2@SrcP {}
  ...
  where
    ...
    isSimple SrcP {} = False
    isSimple PatP {} = False
    isSimple BracketIndexP {} = False
    isSimple BracketSliceP {} = False
