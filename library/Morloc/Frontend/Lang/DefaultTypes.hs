...
defaultRecord lang@(Just Python3Lang) entries = [NamU NamRecord (TV lang "record") entries]
defaultRecord lang@(Just RLang) entries = [NamU NamRecord (TV lang "record") entries]
