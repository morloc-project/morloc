...
defaultNumber lang@Nothing = [VarU (TV lang "Num")]
defaultNumber lang@(Just Python3Lang) = [VarU (TV lang "float")]
defaultNumber lang@(Just RLang) = [VarU (TV lang "numeric")]
defaultNumber lang@(Just CLang) = [VarU (TV lang "double")]
defaultNumber lang@(Just CppLang) = [VarU (TV lang "double")]
