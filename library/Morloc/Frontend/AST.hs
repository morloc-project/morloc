...
findTypeTerms (LitU (LStr _)) = []
findTypeTerms (LitU (LRec fs)) = concatMap (findTypeTerms . snd) fs
findTypeTerms (LitU (LList es)) = concatMap findTypeTerms es
findTypeTerms (LitU (LSet es)) = concatMap findTypeTerms es
