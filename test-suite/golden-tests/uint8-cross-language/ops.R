...
##
## The morloc type [U8] maps to R's `raw` here (declared in main.loc
## as `type R => (List U8) = "raw" U8`). The R runtime always
## materialises a [U8] wire packet as a RAWSXP regardless of hint, so
